        ...
        extend {
            ...
            drawer.rectangleBatch {
                locations.forEachIndexed { index, location ->
                    ...
                    val sinValue = sin(index * seconds % 100 * 0.005) * cos(index * seconds * 0.001)
                    val cosValue = cos(index * seconds % 100 * 0.005) * sin(index * seconds * 0.001)
                    val sinNormalized = map(-1.0, 1.0, 0.0, 0.7, sinValue)
                    val cosNormalized = map(-1.0, 1.0, 0.0, 0.7, cosValue)
